...
const sections = [
  {
    ...
    content: [
      ...
      { heading: 'First Login', body: 'The database is seeded with a super admin account on first run:\n\n• **Username:** admin\n• **Password:** admin\n\nThe super admin has cross-tenant visibility — they can see all servers, users, and audit logs across all organizations. Change the password immediately after first login.' },
    ],
  },
  {
