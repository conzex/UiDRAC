...
export default function PublicHeader() {
  ...
  return (
    <header className="bg-dell-blue text-white shrink-0 sticky top-0 z-50 shadow-md">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm">
            ...
            {isLoggedIn ? (
              <>
                ...
                {isOwner && (
                  <a href="/admin" className="text-white/80 hover:text-white flex items-center gap-1.5"><Shield className="w-3.5 h-3.5" /> Admin</a>
                )}
      ...
      {mobileOpen && (
        <div className="md:hidden border-t border-white/20 px-4 py-3 space-y-2 text-sm max-w-layout mx-auto">
          ...
          {isLoggedIn ? (
            <>
              ...
              {isOwner && <a href="/admin" className="block py-2 text-white/80 hover:text-white">Admin</a>}
